...
class ComplexPredictor < Predictor
  ...
  def train!
    ...
    newarchhash = archhash.sort_by{|k,v| v}.reverse[0..70]
...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    newastrohash = astrohash.sort_by{|k,v| v}.reverse[0..70]
...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    newphilhash = philhash.sort_by{|k,v| v}.reverse[0..70]
...
#-----------------------------
    ...
    newrelhash = relhash.sort_by{|k,v| v}.reverse[0..70]
  ...
  def predict(tokens)
    ...
    @goodtokens.each do |word|
      ...
      newtesthash = testhash.sort_by{|k,v| v}.reverse[0..70]
      @bookarr = []
